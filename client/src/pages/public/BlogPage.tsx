...
export default function BlogPage() {
  ...
  const blogPosts = [
    {
      id: 48,
      slug: 'agentic-coding-needs-requirements-sep-2026',
      title: 'Why Agentic Coding Needs Better Requirements — Not Faster Vibes (2026)',
      excerpt:
        "Builder.io just proved 270 people can build an app from a PRD in 60 minutes. They didn't measure how many had to rebuild it the next week. Here's why structured BRDs prevent AI quality debt.",
  ...
  const filtered = blogPosts.filter((p) => {
    ...
    return activeCategory === 'All' || p.category === p.category;
  });
