 ...
 * PRD Wizard Page
 *
 * AI-powered Q&A wizard for generating Product Requirements Documents.
 * Supports autoStart query param for seamless flow.
 */
            ...
            <Card className="max-w-2xl mx-auto">
              <div className="p-8 text-center">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">
                  Welcome to the PRD Wizard!
                </h2>
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  I'll ask you detailed questions to create a comprehensive Product Requirements Document
                  based on your approved BRD. Your answers will define the technical specifications and features.
                </p>
                <div className="bg-purple-50 dark:bg-purple-950/50 rounded-lg p-4 mb-6">
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                    What to expect:
                  </h3>
                  <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1 text-left">
                    <li>• 5-10 detailed questions about product features and requirements</li>
                    <li>• Questions build upon your approved BRD</li>
                    <li>• Focus on technical specifications and user stories</li>
                    <li>• You can generate the PRD after 3+ questions</li>
                  </ul>
                </div>
                <Button
                  variant="primary"
              ...
              <div className="mb-4 flex items-center justify-between bg-success-50 dark:bg-success-950/50 border border-success-200 dark:border-success-800 rounded-lg p-3">
                <div className="flex items-center gap-2 text-success-800 dark:text-success-200">
                  ...
                  <span className="text-sm font-medium">
                    You've answered enough questions to generate your PRD!
                  </span>
                </div>
                <Button
                  variant="primary"
