...
export interface OAuthButtonsProps {
  onProviderClick: (provider: 'google' | 'github') => Promise<void>;
  error?: string;
  isLoading?: boolean;
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {providers.map((provider) => {
          const isThisProviderLoading =
            (isLoading && loadingProvider === provider.id) ||
            (isLoading && !loadingProvider && activeProvider === provider.id);
          ...
          return (
            <Button
              ...
              disabled={isLoading}
              isLoading={isThisProviderLoading}
            >
              {!isThisProviderLoading && <span className="mr-2">{provider.icon}</span>}
